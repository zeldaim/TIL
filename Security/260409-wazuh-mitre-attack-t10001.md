...
Wazuh Manager가 Docker 컨테이너 내부에서 구동 중이므로, 컨테이너 내 `local\_rules.xml` 파일을 수정해야 합니다.
...
\# if\_matched\_sid를 5760(sshd: authentication failed)으로 설정하여 탐지 트리거 생성

cat > /var/ossec/etc/rules/local\_rules.xml << 'EOF'

<group name="custom\_rules">

&#x20; <rule id="100001" level="10" frequency="5" timeframe="60">

&#x20;   <if\_matched\_sid>5760</if\_matched\_sid>
